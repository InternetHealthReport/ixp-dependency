...
readonly OUTPUT_FILE="../figs/dependency-distribution/combined.dependencies_cdf.pdf"

python3 ./plot-dependency-distribution-combined.py "${ARK}" "${ATLAS}" "${VALID_IXPS}" "${OUTPUT_FILE}"
